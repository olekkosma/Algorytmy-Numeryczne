...
\usepackage[a4paper,bindingoffset=0.2in,%
            left=0.5in,right=0.5in,top=0.3in,bottom=0.4in,%
...
\begin{center}
 \makebox[\textwidth]{\includegraphics[width=20cm,height=6cm]{CzasRazem.png}}
\end{center}
...
\begin{center}
 \makebox[\textwidth]{\includegraphics[width=14cm,height=8cm]{ABCCzasMy.png}}
\end{center}
...
\begin{center}
 \makebox[\textwidth]{\includegraphics[width=16cm,height=10cm]{gaussPrecyzja2.png}}
\end{center}
